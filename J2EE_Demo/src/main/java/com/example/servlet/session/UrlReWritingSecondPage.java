 ...
 * 
 */
@WebServlet("/urlReWritingSecondPage")
public class UrlReWritingSecondPage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UrlReWritingSecondPage() {
		System.out
				.println("\n ------- UrlReWritingSecondPage Constructor Initialize ------- ");
	}
